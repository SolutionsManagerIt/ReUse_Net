...
//using CommonStructsDataUtilities.SQL;
using ReUse_UWP.Common;
using ReUse_UWP.Base;

namespace ReUse_UWP.Base.Performance
{
    /// <summary>
    ...
    public struct _Log
    {
        ...
        private int CurrentRecordsNo;
        private LogsStorage CurrentLogs;
        private List<LogsStorage> LogsToSave;

        private string ServerName;
        private string DataBaseName;
        private SessionLog CurrSession;
        #endregion

        /// <summary>
        /// Start logger with parameters from CurrLogSession
        /// </summary>
        public _Log(SessionLog CurrSession, string ServerName = null, string DataBaseName = null)
        {
            this.CurrSession = CurrSession;
            this.ServerName = ServerName;
            this.DataBaseName = DataBaseName;
            this.CurrentProcess = null;
            this.CurrentLogs = new LogsStorage();
            this.LogsToSave = new List<LogsStorage>();
            this.CurrentRecordsNo = 0;
        }
        ...
        /// </summary>
        public void _E(string ClassName = null, string MethodName = null, string Comments = null, Exception CurrExc = null, bool? IsCritical = null, string ParametersData = null, string ErrorDetails = null, int? ArrayItemSize = null, int? LogIndex = null)
        {
            AddLogError(ClassName, MethodName, Comments, CurrExc, IsCritical, ParametersData, ErrorDetails, ArrayItemSize, LogIndex);
        }

        /// <summary>
        /// Create New Error Log Entry
        /// </summary>
        public void _E(string ClassName = null, string MethodName = null, string Comments = null, Exception CurrExc = null, Cx? CurrCodeType = null)
        {
            if (CurrCodeType == null)
                AddLogError(ClassName, MethodName, Comments, CurrExc);
            else
                AddLogError(ClassName, MethodName, Comments, CurrExc, CurrCodeType.Value.Cr, CurrCodeType.Value.Ce.P, CurrCodeType.Value.Ce.D, CurrCodeType.Value.Ce.As, CurrCodeType.Value.Ce.Li);
        }

        /// <summary>
        /// Create New Error Log Entry
        /// </summary>
        public void _E(string CustomComments = null, Exception CurrExc = null, Cx? CurrCodeType = null)
        {
            string ClassName = null, MethodName = null, ErrComments = CustomComments;

            if (CurrCodeType != null)
            {
                ClassName = CurrCodeType.Value.C.C;
                MethodName = CurrCodeType.Value.C.M;
                ErrComments = CustomComments ?? CurrCodeType.Value.C.Me;
            }

            if (CurrCodeType == null)
                AddLogError(ClassName, MethodName, ErrComments, CurrExc);
            else
                AddLogError(ClassName, MethodName, ErrComments, CurrExc, CurrCodeType.Value.Cr, CurrCodeType.Value.Ce.P, CurrCodeType.Value.Ce.D, CurrCodeType.Value.Ce.As, CurrCodeType.Value.Ce.Li);
        }
        ...
        /// </summary>
        public void _I(Ed? CurrCodeEntry = null, string CustomComments = null, string ParametersData = null, int? ArrayItemSize = null, int? LogIndex = null)
        {
            string ClassName = null, MethodName = null;

            if (CurrCodeEntry != null)
            {
                ClassName = CurrCodeEntry.Value.C;
                MethodName = CurrCodeEntry.Value.M;
            }

            AddLogInformation(ClassName, MethodName, CustomComments, ParametersData, ArrayItemSize, LogIndex);
        }

        /// <summary>
        /// Create New Info Log Entry
        /// </summary>
        public void _I(Cx? CurrCodeType = null, string CustomComments = null, string ParametersData = null, int? ArrayItemSize = null, int? LogIndex = null)
        {
            string ClassName = null, MethodName = null;
        ...
        /// Create New Info Log Entry
        /// </summary>
        public void _I(string ClassName = null, string MethodName = null, string Comments = null, string ParametersData = null, int? ArrayItemSize = null, int? LogIndex = null)
        {
            AddLogInformation(ClassName, MethodName, Comments, ParametersData, ArrayItemSize, LogIndex);
        }
        ...
        public PerformanceLog? _P(string ParametersData = null, string Details = null, bool? GetProcessData = null, int? ArrayItemSize = null, int? PerformanceIndex = null)
        {
            return NewPerfLogEntry(ParametersData, Details, GetProcessData ?? CurrSession.CollectPerfDetails, ArrayItemSize, PerformanceIndex);
        }

        /// <summary>
        /// Create New Performance Log Entry
        /// </summary>
        public PerformanceLog? _P(Cx? CurrCodeType = null)
        {
            if (CurrCodeType != null && CurrCodeType.Value.Cp.L)
                return NewPerfLogEntry(CurrCodeType.Value.Cp.P, CurrCodeType.Value.Cp.D, CurrCodeType.Value.P ?? CurrSession.CollectPerfDetails, CurrCodeType.Value.Cp.As, CurrCodeType.Value.Cp.Li);
            return null;
        }
        ...
        /// <param name="GetProcessData">Get Process Data (memory, processor usage)</param>
        public void _P(PerformanceLog? Log, string ClassName = null, string MethodName = null, string Comments = null, bool? GetProcessData = null)
        {
            AddCreatedPerfRecord(Log, ClassName, MethodName, Comments, GetProcessData ?? false);
        }

        /// <summary>
        /// Add Created Performance Log Record To Storage
        /// </summary>
        public void _P(PerformanceLog? Log, string ClassName = null, string MethodName = null, string Comments = null, Cx? CurrCodeType = null)
        {
            if (CurrCodeType == null)
                AddCreatedPerfRecord(Log, ClassName, MethodName, Comments, false);
            else
                AddCreatedPerfRecord(Log, ClassName, MethodName, Comments, CurrCodeType.Value.P ?? false);
        }

        /// <summary>
        /// Add Created Performance Log Record To Storage
        /// </summary>
        public void _P(PerformanceLog? Log, string CustomComments = null, Cx? CurrCodeType = null)
        {
            ...
            if (CurrCodeType != null)
            {
                ClassName = CurrCodeType.Value.C.C;
                MethodName = CurrCodeType.Value.C.M;
                PerfComments = CustomComments ?? CurrCodeType.Value.C.Cp;
            }

            if (CurrCodeType == null)
                AddCreatedPerfRecord(Log, ClassName, MethodName, PerfComments, false);
            else
                AddCreatedPerfRecord(Log, ClassName, MethodName, PerfComments, CurrCodeType.Value.P ?? false);
        }
        ...
        private void AddLogError(string ClassName = null, string MethodName = null, string Comments = null, Exception CurrExc = null, bool? IsCritical = null, string ParametersData = null, string ErrorDetails = null, int? ArrayItemSize = null, int? LogIndex = null)
        {
            if (!CurrSession.CollectLogs)
                return;

            var EntryGuid = CreateNewCodeEntry(ClassName, MethodName);
            if (!CurrentLogs.ErrorLogs.ContainsKey(EntryGuid))
                CurrentLogs.ErrorLogs.Add(EntryGuid, new List<ErrorLog>());
            ...
            if (CurrExc != null)
            {
                ...
                if (CurrSession.CollectErrorDetails)
                {
            ...
            CurrentLogs.ErrorLogs[EntryGuid].Add(Result);
            CurrentRecordsNo++;

            if (CurrSession.MaxLogsLimit != null && CurrSession.MaxLogsLimit.Value > 1 && CurrentRecordsNo > CurrSession.MaxLogsLimit.Value)
                Save();
        }

        private void AddLogInformation(string ClassName = null, string MethodName = null, string Comments = null, string ParametersData = null, int? ArrayItemSize = null, int? LogIndex = null)
        {
            if (!CurrSession.CollectLogs)
                return;

            var EntryGuid = CreateNewCodeEntry(ClassName, MethodName);
            if (!CurrentLogs.InfoLogs.ContainsKey(EntryGuid))
                CurrentLogs.InfoLogs.Add(EntryGuid, new List<InfoLog>());

            var Result = new InfoLog();
            ...
            CurrentLogs.InfoLogs[EntryGuid].Add(Result);
            CurrentRecordsNo++;
        ...
        /// </summary>
        private PerformanceLog? NewPerfLogEntry(string ParametersData = null, string Details = null, bool GetProcessData = true, int? ArrayItemSize = null, int? PerformanceIndex = null)
        {
        ...
        private void AddCreatedPerfRecord(PerformanceLog? CurrLog, string ClassName = null, string MethodName = null, string Comments = null, bool GetProcessData = true)
        {
            if (!CurrSession.CollectPerfLogs || CurrLog == null)
                return;

            var Log = CurrLog.Value;
            ...
            var EntryGuid = CreateNewCodeEntry(ClassName, MethodName);
            if (!CurrentLogs.PerformanceLogs.ContainsKey(EntryGuid))
                CurrentLogs.PerformanceLogs.Add(EntryGuid, new List<PerformanceLog>());

            CurrentLogs.PerformanceLogs[EntryGuid].Add(Log);
            CurrentRecordsNo++;
        ...
        private void GetCurrentProcessCommonDetails()
        {
            ...
            if (CurrentProcess != null)
            {
                ...
                Result.SessionId = CurrentProcess.SessionId;
                Result.StartTime = CurrentProcess.StartTime;
            }
            CurrentLogs.ProcessLogs.Add(Result);
        }
        ...
        private Guid GetCurrentProcessPerformanceDetails()
        {
            ...
            if (CurrentProcess != null)
            {
                ...
                {
                    CurrentProcess.Refresh();
                    Result.HandleCount = CurrentProcess.HandleCount;
                    Result.NonpagedSystemMemorySize64 = CurrentProcess.NonpagedSystemMemorySize64;
                    Result.PagedMemorySize64 = CurrentProcess.PagedMemorySize64;
                    Result.PagedSystemMemorySize64 = CurrentProcess.PagedSystemMemorySize64;
                    Result.PeakPagedMemorySize64 = CurrentProcess.PeakPagedMemorySize64;
                    Result.PeakVirtualMemorySize64 = CurrentProcess.PeakVirtualMemorySize64;
                    Result.PeakWorkingSet64 = CurrentProcess.PeakWorkingSet64;
                    Result.PrivateMemorySize64 = CurrentProcess.PrivateMemorySize64;
                    Result.PrivilegedProcessorTime = CurrentProcess.PrivilegedProcessorTime;
                    Result.ThreadsCount = CurrentProcess.Threads.Count;
                    Result.VirtualMemorySize64 = CurrentProcess.VirtualMemorySize64;
                    Result.WorkingSet64 = CurrentProcess.WorkingSet64;
                }
                catch (Exception exc)
                {
                    int ttt = 555;
            ...
            CurrentLogs.ProcessDetailsData.Add(NewUID, Result);
            return NewUID;
        }
        ...
        {
            var NewUID = Guid.NewGuid();
            var ClassData = CurrentLogs.Entries.Where(e => e.Class == ClassTitle).G();
            if (ClassData.C())
            {
                var MethodsData = ClassData.First().Methods.Where(e => e.Value == MethodTitle).G();
                if (MethodsData.C())
                    return MethodsData.First().Key;
                else
        ...
        {
            EnvironmentDetails Result = new EnvironmentDetails();
            ...
            if (CurrSession.CollectOSData && Environment.OSVersion != null)
            {
            ...
            CurrentLogs.Environments.Add(Result);
        }
        ...
        public bool Save(bool StartNewLogsAfterSave = true)
        {
            ...
            {
                Copy.S(Curr.ServerName, Curr.DataBaseName, Curr.CurrSession, c);
                Copy.I();
                return true;
            };
    ...
    public static class Log_Utilities
    {
        ...
        /// </summary>
        public static SessionLog _Ls(this bool CollectPerfLogs, bool CollectErrorDetails = true, bool CollectPerfDetails = true, bool CollectUsers = true, bool CollectOSData = true, int? MaxLogsLimit = 10000)
        {
            var r = new SessionLog();

            r.Session_UID = Guid.NewGuid();
        ...
        /// </summary>
        public static SessionLog S(this SessionLog CurrentSessionLog, bool CollectErrorDetails = true, bool CollectPerfDetails = true, bool CollectUsers = true, bool CollectOSData = true, int? MaxLogsLimit = 10000)
        {
            var r = new SessionLog();
        ...
        /// </summary>
        public static _Log L(this SessionLog CurrSession, string ServerName = null, string DataBaseName = null)
        {
            return new _Log(CurrSession, ServerName, DataBaseName);
        }
    ...
    public static class Log_Storage_Utilities
    {
        ...
        /// </summary>
        public static LogsStorage I(this LogsStorage CurrLogsStorage, bool CollectPerfLogs = true, bool CollectProcessDetails = true, bool CollectUsers = true, bool CollectHttpWeb = true, bool CollectBrowsers = true)
        {
            //var r = new LogsStorage();

            CurrLogsStorage.Entries = new List<EntryData>();
            CurrLogsStorage.ErrorLogs = new Dictionary<Guid, List<ErrorLog>>();
            CurrLogsStorage.InfoLogs = new Dictionary<Guid, List<InfoLog>>();
            CurrLogsStorage.Environments = new List<EnvironmentDetails>();
            if (CollectPerfLogs)
                CurrLogsStorage.PerformanceLogs = new Dictionary<Guid, List<PerformanceLog>>();
            if (CollectProcessDetails)
            {
                CurrLogsStorage.ProcessLogs = new List<ProcessLog>();
                CurrLogsStorage.ProcessDetailsData = new Dictionary<Guid, ProcessDetails>();

            }
            if (CollectHttpWeb)
            {
                CurrLogsStorage.HttpRequests = new List<HttpRequestLog>();
                CurrLogsStorage.HttpSessions = new List<HttpSessionLog>();
                CurrLogsStorage.HttpContexts = new List<HttpContextLog>();
                CurrLogsStorage.WebPages = new List<WebPageLog>();
                if (CollectUsers)
                    CurrLogsStorage.WebProfiles = new List<WebProfileLog>();
                if (CollectBrowsers)
                    CurrLogsStorage.HttpBrowsers = new List<HttpBrowserCapabilitiesLog>();
            }
            if (CollectUsers)
                CurrLogsStorage.WindowsIdentities = new List<WindowsIdentityLog>();
